<section class="swiper hero_slider ">
    <div class="swiper-wrapper min-vh-100 vh-lg-50">
        ...
        $image = get_field('hero_img_left');
        if ($images && $image) : ?>
        <div class="swiper-slide hero-slide bg-primary">
            <img class="position-absolute top-0 start-0 h-100" data-aos="fade-left" data-aos-duration="500"
                 src="<?= $images['url']; ?>" alt="<?= $images['title']; ?>">
            <img class="position-absolute top-0 end-0 h-auto col-7 col-lg-12 sun" data-aos="fade-down-right"
                 data-aos-duration="1000" src="<?= $image['url']; ?>" alt="<?= $image['title']; ?>">
            <div class="container position-relative h-100">
                <div class="position-absolute top-50 start-100 col-10 col-lg-3 translate-middle-x text-end text-white start-lg-50">
                    <p data-aos="fade-right" data-aos-delay="200"><?= get_field('slogan_description'); ?></p>
                    <h1 data-aos="fade-right" data-aos-delay="300"><?= get_field('slogan'); ?></h1>
                </div>
                <div data-aos="fade-right" data-aos-delay="400" class="position-absolute top-75 start-100 start-lg-50">
