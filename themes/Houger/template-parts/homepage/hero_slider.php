<section class="min-vh-100 vh-lg-50">
    <?php
    $video = get_field('hero_video');
    if ($video) : ?>
        <video class="img-fluid h-100" autoplay muted loop>
            <source src="<?= $video['url']; ?>" src="<?= $video['url']; ?>">
        </video>
        <div class="position-absolute top-75 start-75 col-10 col-lg-3 translate-middle-x text-end text-white start-lg-50">
            ...
            <a href="tel:<?= get_field('phone', 'option'); ?>" data-aos="fade-right" data-aos-delay="400"
               class="btn mt-3 btn-white fs-6 fw-bold"> مشاوره
