<section class="position-relative">
    ...
    if ($video) : ?>
        ...
        <div class="position-absolute top-50 top-lg-75 start-75 col-10 col-lg-3 translate-middle-x text-end text-white start-lg-50">
            <p class="mb-0 mb-1" data-aos="fade-right" data-aos-delay="200"><?= get_field('slogan_description'); ?></p>
