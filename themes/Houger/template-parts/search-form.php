<button class="btn text-primary d-none d-lg-inline fs-6" type="button" aria-label="Open search modal" data-bs-toggle="offcanvas" data-bs-target="#offcanvasSearch" aria-controls="offcanvasTop">
