<div class="px-0 position-relative overflow-hidden post-card border border-1 border-white" <?= $args['modal'] ?? ''; ?>  style="height: 400px;">
        ...
        <div class="portfilio_detail">
            ...
            if ($client) {
                ...
                <img class="object-fit ms-n2" width="150" height="150"
                     src="<?= $client_thumb; ?>" alt="<?= $client_name; ?>">
                <h6 class="fs-5 mt-n4 ps-4"><?= get_the_title(); ?></h6>
            <?php }
            if (!$client) { ?>
                <h6 class="fs-5 pt-4 ps-3"><?= get_the_title(); ?></h6>
            <?php } ?>
        </div>
